<?php 
add_action( 'wp_enqueue_scripts', 'the_newspaper_bureau_enqueue_styles' );
function the_newspaper_bureau_enqueue_styles() {
	wp_enqueue_style( 'the-newspaper-bureau-style', get_template_directory_uri() . '/style.css' ); 
} 

function the_newspaper_bureau_enqueue_assets() {
	// Include the file.
	...
	wp_enqueue_style(
		'Inter',
		wptt_get_webfont_url( 'https://fonts.googleapis.com/css2?family=Archivo:wght@600&family=Inter:wght@400;600&display=auto' ),
		array(),
		'1.0'
	);
}
add_action( 'wp_enqueue_scripts', 'the_newspaper_bureau_enqueue_assets' );





function the_newspaper_bureau_customize_register( $wp_customize ) {
	/* New Section */
	$wp_customize->add_section( 'footer_settings', array(
		'title'      => __('Footer Settings','the-newspaper-bureau'),
		'priority'   => 1,
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'footer_headline_color', array(
		'label'       => __( 'Headline Color', 'the-newspaper-bureau' ),
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'footer_text_color', array(
		'label'       => __( 'Text Color', 'the-newspaper-bureau' ),
		'section'     => 'footer_settings',
		'priority'   => 1,
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'footer_link_color', array(
		'label'       => __( 'Link Color', 'the-newspaper-bureau' ),
		'section'     => 'footer_settings',
		'priority'   => 1,
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'footer_border_color', array(
		'label'       => __( 'Border Color', 'the-newspaper-bureau' ),
		'section'     => 'footer_settings',
		'priority'   => 1,
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'footer_background_color', array(
		'label'       => __( 'Background Color', 'the-newspaper-bureau' ),
		'section'     => 'footer_settings',
		'priority'   => 1,
	...
	$wp_customize->add_section( 'navigation_settings', array(
		'title'      => __('Navigation Settings','the-newspaper-bureau'),
		'priority'   => 1,
		'capability' => 'edit_theme_options',
	) );
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_background_color', array(
		'label'       => __( 'Header Background Color', 'the-newspaper-bureau' ),
...
add_action( 'customize_register', 'the_newspaper_bureau_customize_register', 999 );




if(! function_exists('the_newspaper_bureau_customizer_css_final_output' ) ):
	function the_newspaper_bureau_customizer_css_final_output(){
		?>
	...
	<?php }
	add_action( 'wp_head', 'the_newspaper_bureau_customizer_css_final_output' );
endif;